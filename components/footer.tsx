...
import { Github, Linkedin, Mail, Twitter, Heart, Trophy, Camera, Users } from "lucide-react"
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between md:gap-4">
          ...
          >
            {[
              ...
              { href: "https://www.kaggle.com/pratiktech28", icon: Trophy, label: "Kaggle" },
              { href: "https://www.instagram.com/pratiktech28/", icon: Camera, label: "Instagram" },
              { href: "https://discord.com/users/pratiktech28", icon: Users, label: "Discord" },
            ].map((social, index) => (
              <motion.div
                key={social.label}
